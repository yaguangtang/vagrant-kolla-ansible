...
# Create the volume with the specified volume type
snapshot_id = '560c70d1-d602-4270-821e-5f1dc5801b5e'
volume_size=1
# volume size must be equal or greater than snapshot size
volume = cinder.volumes.create(size=volume_size,snapshot_id=snapshot_id)

# Print the newly created volume details
