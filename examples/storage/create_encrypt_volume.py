...
cinder = cinder_client.Client(3session=sess,region_name="RegionOne",endpoint_type='publicURL')

# this volume type has to be created by admin.
volume_type_name = 'LUKS'
volume_type = cinder.volume_types.find(name=volume_type_name)
